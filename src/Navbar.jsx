...
import logo from "./assets/website-icon.svg";
...
function MobileMenu({ onClose }) {
  ...
  return (
    <div className="main-nav-menu-mobile z-50 bg-white/90 shadow-sm lg:shadow-none absolute left-0 top-0 bottom-0 right-0 border-r border-slate-400/30 border-dashed w-[270px] md:w-[300px] lg:flex lg:w-[300px] lg:flex-col">
      <button>
      ...
      <div className="header-menu lg:hidden">
        ...
        <div className="header-button space-y-2">
          <div className="px-6 lg:flex lg:items-center">
            <a
              href="#"
              className="flex w-full items-center text-white justify-center rounded-full bg-[#EDA35E] px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200"
            >
              <span>Join now</span>
            </a>
          </div>
...
function Navbar() {
  ...
  return (
    <div className="navbar-home top-0 py-2 lg:py-5 px-2 w-full bg-transparent lg:relative  ">
      <nav className="z-10 sticky top-0 bg-[#242424] left-0 right-0 max-w-4xl xl:max-w-5xl mx-auto px-5 lg:px-2 py-2.5 lg:border-none lg:py-2 rounded-full">
        <div className="flex items-center justify-between">
          <button>
            <div className="header-logo flex items-center space-x-2">
              ...
              <h2 className="text-white font-bold">Side</h2>
            </div>
          </button>
          <div className="header-menu hidden  lg:flex items-center gap-x-10">
            ...
            <div className="header-button space-x-2">
              <div className="hidden lg:flex lg:items-center gap-x-2">
                <button className="flex items-center text-white justify-center rounded-full bg-[#EDA35E] px-5 py-2 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                  <span>Try for free</span>
                </button>
                <button className="flex items-center text-white justify-center rounded-full bg-[#FFFFFF]/20 px-5 py-2 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                  <span>Login</span>
                </button>
              </div>
            </div>
